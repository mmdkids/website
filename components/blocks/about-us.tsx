...
export default function AboutSection() {
  return (
    <section className="w-full font-fredoka bg-accent text-black py-20 px-6 md:px-20 flex flex-col md:flex-row gap-16 items-center justify-between">
      {/* Left Images */}
      ...
      {/* Right Content */}
      <div className="w-full md:w-1/2 flex flex-col gap-6 pl-0 md:pl-20">

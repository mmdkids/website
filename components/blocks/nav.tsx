...
const IHeader: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="bg-primary lg:py-0 py-2 bg-blue dark:bg-dark">
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) flex items-center justify-between px-4">
          ...
          <div className="flex items-center space-x-4 relative top-px">
            ...
            <Link
              href="#"
              className="hidden lg:block bg-error border border-accent text-sm hover:bg-error/90 text-white px-4 py-3.5 leading-none rounded-lg font-medium text-nowrap"
              onClick={() => {
      ...
      <div className="px-4 container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) sm:flex lg:justify-between justify-center py-5 hidden">
        ...
        <div className="flex items-center">
          ...
          <button onClick={() => ('')}  className="text-error text-sm font-semibold border border-primary py-4 px-7 rounded-md ml-8 hover:bg-error hover:text-primary hover:border-primary">
            Parent Login
          </button>
        </div>
      </div>

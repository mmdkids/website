        ...
        <footer className="bg-white py-12 dark:bg-transparent font-fredoka">
            <div className="mx-auto text-xl md:text-3xl max-w-7xl px-6">
                <div className="flex flex-wrap justify-between gap-6">
                    <span className="text-muted-foreground order-last block text-left  md:order-first">© {new Date().getFullYear()} Mastermind Daycare, <br className='block md:hidden'/>  All rights reserved</span>
